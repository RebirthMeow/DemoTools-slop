...
extern float AngleDelta( float, float );   // comes from q_math.c
...
typedef struct povInfo_s {
	int povClient;       // current ps.clientNum we are looking through
	info_t info;         // start/end bookkeeping (already defined)
} povInfo_t;
